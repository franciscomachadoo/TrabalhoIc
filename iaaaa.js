...
let intervalor = null; // Adicione essa variável para controlar o contador
...
contador(); // Chame a função contador apenas uma vez, fora do evento submit

document.getElementById("btn-reset").addEventListener("click", function () {
  clearInterval(intervalor); // Limpe o intervalo antes de recomeçar o contador
